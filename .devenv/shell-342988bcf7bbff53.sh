...
exec node -e '
const m = require("maplibre-gl");
console.log("keys:", Object.keys(m).slice(0, 20));
console.log("has default:", typeof m.default);
console.log("has Map:", typeof m.Map);
console.log("has Popup:", typeof m.Popup);
console.log("has Marker:", typeof m.Marker);
'