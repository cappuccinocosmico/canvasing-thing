...
export shell
DEVENV_PROFILE='/nix/store/hnys97wy83089azrcs3xcn9yn4wkzrqn-devenv-profile'
...
out='/nix/store/gn7f17xrlw04f3gjjkrckamfrgvsyxjk-devenv-shell-env'
export out
NM='nm'
export NM
depsTargetTarget=''
...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/9ypz3flqsrl5xl495mm8h645gadjsxi1-coreutils-9.11/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/hnys97wy83089azrcs3xcn9yn4wkzrqn-devenv-profile" ]
then
  ln -snf /nix/store/hnys97wy83089azrcs3xcn9yn4wkzrqn-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
declare -a pkgsBuildHost=('/nix/store/bvsy09r85z0q1m30p87s1bf4ikb0s84i-bash-interactive-5.3p9-dev' '/nix/store/cgjr3kj3hs7ngznyws5qfg16c8scpys0-bash-interactive-5.3p9' '/nix/store/5a8ysg1jnj8jmzzyfcfw7rvpvnp5rfpa-nodejs-24.15.0' '/nix/store/9np2lg3ii3d0sk9f35lwbxrslss1q57d-pnpm-11.5.3' '/nix/store/0fm002iw8wq367lmwp520ml62ag5pq56-typescript-language-server-5.3.0' '/nix/store/13rwj2rxdbis2sv6lbdnm92gc8kjrlsh-hello' '/nix/store/bcnisk3ydfgv26v2gw3zlky24g00yww2-git-2.54.0' '/nix/store/1m05k7xgfnw6jc21xxk5681ni3ar97wf-pkg-config-wrapper-0.29.2' '/nix/store/ilblcn1dkvzghcr2yk3av6jxn5rk1iqw-patchelf-0.15.2' '/nix/store/xknj6c33cc197s60ry0i69vdkmaizrs1-update-autotools-gnu-config-scripts-hook' '/nix/store/0y5xmdb7qfvimjwbq7ibg1xdgkgjwqng-no-broken-symlinks.sh' '/nix/store/cv1d7p48379km6a85h4zp6kr86brh32q-audit-tmpdir.sh' '/nix/store/85clx3b0xkdf58jn161iy80y5223ilbi-compress-man-pages.sh' '/nix/store/p3l1a5y7nllfyrjn2krlwgcc3z0cd3fq-make-symlinks-relative.sh' '/nix/store/5yzw0vhkyszf2d179m0qfkgxmp5wjjx4-move-docs.sh' '/nix/store/fyaryjvghbkpfnsyw97hb3lyb37s1pd6-move-lib64.sh' '/nix/store/kd4xwxjpjxi71jkm6ka0np72if9rm3y0-move-sbin.sh' '/nix/store/pag6l61paj1dc9sv15l7bm5c17xn5kyk-move-systemd-user-units.sh' '/nix/store/cmzya9irvxzlkh7lfy6i82gbp0saxqj3-multiple-outputs.sh' '/nix/store/x8c40nfigps493a07sdr2pm5s9j1cdc0-patch-shebangs.sh' '/nix/store/cickvswrvann041nqxb0rxilc46svw1n-prune-libtool-files.sh' '/nix/store/xyff06pkhki3qy1ls77w10s0v79c9il0-reproducible-builds.sh' '/nix/store/z7k98578dfzi6l3hsvbivzm7hfqlk0zc-set-source-date-epoch-to-latest.sh' '/nix/store/pilsssjjdxvdphlg2h19p0bfx5q0jzkn-strip.sh' '/nix/store/788mx070y81zjlg5ipcl0cra3afviw9k-gcc-wrapper-15.2.0' '/nix/store/mbyy19mdwnfvfwmdi0gqgggx0njvpl1w-binutils-wrapper-2.46' )
OSTYPE='linux-gnu'
...
PS4='+ '
NIX_LDFLAGS='-rpath /nix/store/gn7f17xrlw04f3gjjkrckamfrgvsyxjk-devenv-shell-env/lib '
export NIX_LDFLAGS
...
exec tsx -e 'import("./src/lib/db/client.ts").then(async ({db}) => { const {addresses, people, visits} = await import("./src/lib/db/schema.ts"); console.log("addresses:", db.select().from(addresses).all().length); console.log("people:", db.select().from(people).all().length); console.log("visits:", db.select().from(visits).all().length); })'