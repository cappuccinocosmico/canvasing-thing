# Disable history during init so devenv internal commands do not pollute history.
set +o history
...
source "/home/nicole/Documents/canvasing-thing/.devenv/shell-env.sh"
...
if [ ! -x "/nix/store/gdlvizwr80wwccx2v39h2as02rs0d1nb-fish-4.7.1/bin/fish" ] && ! command -v "/nix/store/gdlvizwr80wwccx2v39h2as02rs0d1nb-fish-4.7.1/bin/fish" >/dev/null 2>&1; then
    echo "devenv: error: shell '/nix/store/gdlvizwr80wwccx2v39h2as02rs0d1nb-fish-4.7.1/bin/fish' not found" >&2
    echo "devenv: add fish to your devenv.nix packages or set SHELL to an absolute path" >&2
    exit 1
fi
exec "/nix/store/gdlvizwr80wwccx2v39h2as02rs0d1nb-fish-4.7.1/bin/fish" -i -C "source /home/nicole/Documents/canvasing-thing/.devenv/devenv.fish"
echo "devenv: error: failed to exec into /nix/store/gdlvizwr80wwccx2v39h2as02rs0d1nb-fish-4.7.1/bin/fish" >&2
exit 1
