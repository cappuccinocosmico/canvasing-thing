...
DEVENV_PROFILE='/nix/store/aj6a65smwn4r3dwbb6sar0478xzphcmx-devenv-profile'
...
OLDPWD=''
export OLDPWD
PLAYWRIGHT_BROWSERS_PATH='/nix/store/74pigixd0119xcwibmdsmgy7ikn09qbk-playwright-browsers'
...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/9ypz3flqsrl5xl495mm8h645gadjsxi1-coreutils-9.11/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/aj6a65smwn4r3dwbb6sar0478xzphcmx-devenv-profile" ]
then
  ln -snf /nix/store/aj6a65smwn4r3dwbb6sar0478xzphcmx-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
mkdir -p /run/user/1000/devenv-258769a
ln -snf /run/user/1000/devenv-258769a /home/nicole/Documents/canvasing-thing/.devenv/run


source /nix/store/c40kgj3i0sqhw8na7ablp0qisb7nk9cw-init-pnpm.sh
...
{
  if [[ ":${DIRENV_ACTIVE-}:" == *":/home/nicole/Documents/canvasing-thing:"* ]]; then
...
export cmakeFlags
outputDev='out'
NIX_CFLAGS_COMPILE=' -frandom-seed=ms2jvrci4i -isystem /nix/store/bvsy09r85z0q1m30p87s1bf4ikb0s84i-bash-interactive-5.3p9-dev/include -isystem /nix/store/5a8ysg1jnj8jmzzyfcfw7rvpvnp5rfpa-nodejs-24.15.0/include -isystem /nix/store/bvsy09r85z0q1m30p87s1bf4ikb0s84i-bash-interactive-5.3p9-dev/include -isystem /nix/store/5a8ysg1jnj8jmzzyfcfw7rvpvnp5rfpa-nodejs-24.15.0/include'
...
'
export buildPhase
NIX_LDFLAGS='-rpath /nix/store/ms2jvrci4iyaafi7ky2c7issn2z7xafq-devenv-shell-env/lib '
export NIX_LDFLAGS
OBJDUMP='objdump'
export OBJDUMP
PLAYWRIGHT_NODEJS_PATH='/nix/store/5a8ysg1jnj8jmzzyfcfw7rvpvnp5rfpa-nodejs-24.15.0/bin/node'
...
LD='ld'
export LD
PLAYWRIGHT_LAUNCH_OPTIONS_EXECUTABLE_PATH='/nix/store/74pigixd0119xcwibmdsmgy7ikn09qbk-playwright-browsers/chromium-1223/chrome-linux64/chrome'
...
nativeBuildInputs='/nix/store/bvsy09r85z0q1m30p87s1bf4ikb0s84i-bash-interactive-5.3p9-dev /nix/store/5a8ysg1jnj8jmzzyfcfw7rvpvnp5rfpa-nodejs-24.15.0 /nix/store/9np2lg3ii3d0sk9f35lwbxrslss1q57d-pnpm-11.5.3 /nix/store/0fm002iw8wq367lmwp520ml62ag5pq56-typescript-language-server-5.3.0 /nix/store/13rwj2rxdbis2sv6lbdnm92gc8kjrlsh-hello /nix/store/dychrswv3agcp5vcnk6vxbzmmnk2pqf0-playwright-version-check /nix/store/bcnisk3ydfgv26v2gw3zlky24g00yww2-git-2.54.0 /nix/store/1m05k7xgfnw6jc21xxk5681ni3ar97wf-pkg-config-wrapper-0.29.2'
export nativeBuildInputs
XDG_DATA_DIRS='/nix/store/cgjr3kj3hs7ngznyws5qfg16c8scpys0-bash-interactive-5.3p9/share:/nix/store/5a8ysg1jnj8jmzzyfcfw7rvpvnp5rfpa-nodejs-24.15.0/share:/nix/store/9np2lg3ii3d0sk9f35lwbxrslss1q57d-pnpm-11.5.3/share:/nix/store/bcnisk3ydfgv26v2gw3zlky24g00yww2-git-2.54.0/share:/nix/store/1m05k7xgfnw6jc21xxk5681ni3ar97wf-pkg-config-wrapper-0.29.2/share:/nix/store/ilblcn1dkvzghcr2yk3av6jxn5rk1iqw-patchelf-0.15.2/share'
export XDG_DATA_DIRS
depsHostHostPropagated=''
export depsHostHostPropagated
DEVENV_STATE='/home/nicole/Documents/canvasing-thing/.devenv/state'
export DEVENV_STATE
...
out='/nix/store/ms2jvrci4iyaafi7ky2c7issn2z7xafq-devenv-shell-env'
export out
...
export RANLIB
outputInclude='out'
DEVENV_ROOT='/home/nicole/Documents/canvasing-thing'
export DEVENV_ROOT
DEVENV_TASK_FILE='/nix/store/hi0krflfpsha67asq5jw1k9hv3qlfjdj-tasks.json'
...
declare -a pkgsBuildHost=('/nix/store/bvsy09r85z0q1m30p87s1bf4ikb0s84i-bash-interactive-5.3p9-dev' '/nix/store/cgjr3kj3hs7ngznyws5qfg16c8scpys0-bash-interactive-5.3p9' '/nix/store/5a8ysg1jnj8jmzzyfcfw7rvpvnp5rfpa-nodejs-24.15.0' '/nix/store/9np2lg3ii3d0sk9f35lwbxrslss1q57d-pnpm-11.5.3' '/nix/store/0fm002iw8wq367lmwp520ml62ag5pq56-typescript-language-server-5.3.0' '/nix/store/13rwj2rxdbis2sv6lbdnm92gc8kjrlsh-hello' '/nix/store/dychrswv3agcp5vcnk6vxbzmmnk2pqf0-playwright-version-check' '/nix/store/bcnisk3ydfgv26v2gw3zlky24g00yww2-git-2.54.0' '/nix/store/1m05k7xgfnw6jc21xxk5681ni3ar97wf-pkg-config-wrapper-0.29.2' '/nix/store/ilblcn1dkvzghcr2yk3av6jxn5rk1iqw-patchelf-0.15.2' '/nix/store/xknj6c33cc197s60ry0i69vdkmaizrs1-update-autotools-gnu-config-scripts-hook' '/nix/store/0y5xmdb7qfvimjwbq7ibg1xdgkgjwqng-no-broken-symlinks.sh' '/nix/store/cv1d7p48379km6a85h4zp6kr86brh32q-audit-tmpdir.sh' '/nix/store/85clx3b0xkdf58jn161iy80y5223ilbi-compress-man-pages.sh' '/nix/store/p3l1a5y7nllfyrjn2krlwgcc3z0cd3fq-make-symlinks-relative.sh' '/nix/store/5yzw0vhkyszf2d179m0qfkgxmp5wjjx4-move-docs.sh' '/nix/store/fyaryjvghbkpfnsyw97hb3lyb37s1pd6-move-lib64.sh' '/nix/store/kd4xwxjpjxi71jkm6ka0np72if9rm3y0-move-sbin.sh' '/nix/store/pag6l61paj1dc9sv15l7bm5c17xn5kyk-move-systemd-user-units.sh' '/nix/store/cmzya9irvxzlkh7lfy6i82gbp0saxqj3-multiple-outputs.sh' '/nix/store/x8c40nfigps493a07sdr2pm5s9j1cdc0-patch-shebangs.sh' '/nix/store/cickvswrvann041nqxb0rxilc46svw1n-prune-libtool-files.sh' '/nix/store/xyff06pkhki3qy1ls77w10s0v79c9il0-reproducible-builds.sh' '/nix/store/z7k98578dfzi6l3hsvbivzm7hfqlk0zc-set-source-date-epoch-to-latest.sh' '/nix/store/pilsssjjdxvdphlg2h19p0bfx5q0jzkn-strip.sh' '/nix/store/788mx070y81zjlg5ipcl0cra3afviw9k-gcc-wrapper-15.2.0' '/nix/store/mbyy19mdwnfvfwmdi0gqgggx0njvpl1w-binutils-wrapper-2.46' )
outputs='out'
export outputs
prefix='/nix/store/ms2jvrci4iyaafi7ky2c7issn2z7xafq-devenv-shell-env'
NIX_STORE='/nix/store'
export NIX_STORE
LINENO='79'
declare -a postFixupHooks=('noBrokenSymlinksInAllOutputs' '_makeSymlinksRelative' '_multioutPropagateDev' )
PKG_CONFIG_PATH='/nix/store/bvsy09r85z0q1m30p87s1bf4ikb0s84i-bash-interactive-5.3p9-dev/lib/pkgconfig'
...
DEVENV_RUNTIME='/run/user/1000/devenv-258769a'
...
phases='buildPhase'
export phases
PATH='/nix/store/cgjr3kj3hs7ngznyws5qfg16c8scpys0-bash-interactive-5.3p9/bin:/nix/store/5a8ysg1jnj8jmzzyfcfw7rvpvnp5rfpa-nodejs-24.15.0/bin:/nix/store/9np2lg3ii3d0sk9f35lwbxrslss1q57d-pnpm-11.5.3/bin:/nix/store/0fm002iw8wq367lmwp520ml62ag5pq56-typescript-language-server-5.3.0/bin:/nix/store/13rwj2rxdbis2sv6lbdnm92gc8kjrlsh-hello/bin:/nix/store/dychrswv3agcp5vcnk6vxbzmmnk2pqf0-playwright-version-check/bin:/nix/store/bcnisk3ydfgv26v2gw3zlky24g00yww2-git-2.54.0/bin:/nix/store/1m05k7xgfnw6jc21xxk5681ni3ar97wf-pkg-config-wrapper-0.29.2/bin:/nix/store/ilblcn1dkvzghcr2yk3av6jxn5rk1iqw-patchelf-0.15.2/bin:/nix/store/788mx070y81zjlg5ipcl0cra3afviw9k-gcc-wrapper-15.2.0/bin:/nix/store/qxaq7jz61a6zkr2mq49i0zvqip2m2jj8-gcc-15.2.0/bin:/nix/store/bsh7n2nx8ndmm1mmww6v2h4851nalj13-glibc-2.42-61-bin/bin:/nix/store/9ypz3flqsrl5xl495mm8h645gadjsxi1-coreutils-9.11/bin:/nix/store/mbyy19mdwnfvfwmdi0gqgggx0njvpl1w-binutils-wrapper-2.46/bin:/nix/store/s2946bl9ciwzhafd66jhansrmxq9xhqm-binutils-2.46/bin:/nix/store/9ypz3flqsrl5xl495mm8h645gadjsxi1-coreutils-9.11/bin:/nix/store/c1cjgg6p8m8fssivzrc2p13mwwml3p3v-findutils-4.10.0/bin:/nix/store/ww555mznia5v7sz2w85lblg4amvhkhv1-diffutils-3.12/bin:/nix/store/kgxafhycw2kybbqih759ykc2043qyi5j-gnused-4.9/bin:/nix/store/gn94gpcp5q08x4v6g8mvw8v4r65rcjzk-gnugrep-3.12/bin:/nix/store/wp1cshqv98i8abs8rcx91s54igqgll0f-gawk-5.4.0/bin:/nix/store/k5akwnrn9x2afaj2va7g4a2zpdim8l43-gnutar-1.35/bin:/nix/store/ndpbjk6jhw0da5h272dqqnyxa35a9gmx-gzip-1.14/bin:/nix/store/3y3kzc5njlj7nwj1s78am0yzjnpicv9x-bzip2-1.0.8-bin/bin:/nix/store/vlq7nnw39j7rwk0pp68w1fcwzpxahm9h-gnumake-4.4.1/bin:/nix/store/gik3rh1vz2jlgnifb9dh6vc6sxwwz9jj-bash-5.3p9/bin:/nix/store/wgvplwp0faqhqr92w0ma8bxaxk202ama-patch-2.8/bin:/nix/store/csra6zhdjw7rjzv98fycz7qjalyv55k2-xz-5.8.3-bin/bin:/nix/store/kyz3mm5snbb8998kbkm28jps1phk9509-file-5.47/bin'
export PATH
depsTargetTarget=''
...
DEVENV_DOTFILE='/home/nicole/Documents/canvasing-thing/.devenv'
...
exec node --experimental-strip-types --no-warnings -e 'console.log('\''hello from node'\''); import('\''playwright'\'').then(p => console.log('\''playwright loaded, chromium type:'\'', typeof p.chromium)).catch(e => console.error('\''err:'\'', e.message))'