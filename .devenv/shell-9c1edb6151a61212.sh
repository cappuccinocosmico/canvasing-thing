...
exec node -e 'const pkg = require("maplibre-gl/package.json"); console.log("main:", pkg.main); console.log("module:", pkg.module); console.log("exports:", JSON.stringify(pkg.exports, null, 2)); console.log("type:", pkg.type);'